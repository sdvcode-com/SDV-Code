...
namespace SdvCode.Web.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseWebsiteActions_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "BaseWebsiteImages",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CloudinaryPath = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ImageType = table.Column<int>(type: "int", nullable: false),
                    FrontName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseWebsiteImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BaseWebsiteImages_BaseData_Id",
                        column: x => x.Id,
                        principalTable: "BaseData",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseWebsiteImages_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasePostImages_BaseWebsiteImages_Id",
                        column: x => x.Id,
                        principalTable: "BaseWebsiteImages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BasePostImages_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseWebsiteActions_OwnerId",
                table: "BaseWebsiteActions",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseWebsiteImages_OwnerId",
                table: "BaseWebsiteImages",
                column: "OwnerId");
