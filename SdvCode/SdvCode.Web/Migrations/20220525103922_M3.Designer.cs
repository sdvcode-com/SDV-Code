...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SdvCode.Models.WebsiteActions.Post.AddedPostToFavoriteAction", b =>
                {
                    b.HasBaseType("SdvCode.Models.WebsiteActions.BasePostAction");

                    b.ToTable("AddedPostToFavoriteActions", (string)null);
                });

            modelBuilder.Entity("SdvCode.Models.WebsiteActions.Post.AddPostToFavoriteAction", b =>
                {
                    b.HasBaseType("SdvCode.Models.WebsiteActions.BasePostAction");

                    b.ToTable("AddPostToFavoriteActions", (string)null);
                });
            ...
            modelBuilder.Entity("SdvCode.Models.WebsiteActions.Post.AddedPostToFavoriteAction", b =>
                {
                    b.HasOne("SdvCode.Models.WebsiteActions.BasePostAction", null)
                        .WithOne()
                        .HasForeignKey("SdvCode.Models.WebsiteActions.Post.AddedPostToFavoriteAction", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SdvCode.Models.WebsiteActions.Post.AddPostToFavoriteAction", b =>
                {
                    b.HasOne("SdvCode.Models.WebsiteActions.BasePostAction", null)
                        .WithOne()
                        .HasForeignKey("SdvCode.Models.WebsiteActions.Post.AddPostToFavoriteAction", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
